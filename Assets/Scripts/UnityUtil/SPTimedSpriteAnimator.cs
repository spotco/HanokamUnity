...
public class SPTimedSpriteAnimator {
	...
	public static SPTimedSpriteAnimator cons(SPSprite target) {
	...
	public SPTimedSpriteAnimator i_cons(SPSprite target) {
		this.set_target(target);
		return this;
	}

	public SPTimedSpriteAnimator set_target(SPSprite target) {
		_target = target;
		return this;
	}
